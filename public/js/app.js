...
$(document).scroll( function() {
    ...
    if ( value > 80 )
	{
        $("#io-navbar .navbar-brand > img").attr("src", "/images/logo-io-s1.png");
		$("#io-navbar .navbar-brand").css({
			"padding-top": "4px",
			"padding-bottom": "5px",
			"height": "32px"
		});
		$("#io-navbar.navbar").css("min-height", "32px");
		$(".page-container").css({
			"margin-top": "32px"
		});
		$("#io-navbar.navbar-default .navbar-nav > li > a").css({
			"padding-top": "5px",
			"padding-bottom": "5px"
		});
	}
	...
	{
        $("#io-navbar .navbar-brand > img").attr("src", "/images/logo-io-s.png");
		$("#io-navbar .navbar-brand").css("padding-top", "15px");
		$("#io-navbar.navbar").css("min-height", "60px");
		$("#io-navbar .navbar-brand").css({
			"padding-top": "15px",
			"padding-bottom": "0",			
			"height": "50px"
